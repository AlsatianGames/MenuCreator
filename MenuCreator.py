...
# Función asincrónica para obtener el Chat ID de un grupo
async def obtener_chat_id_async():
    ...
    for update in updates:
        # Verifica si el mensaje proviene de un grupo o supergrupo
...
root.iconphoto(True, tk.PhotoImage(file="MenuCreatorBot.png")) 
